...
export_model('logistic_regression_tfidf', best_estimator)
export_classification_reports('logistic_regression_tfidf', y_pred, y_test, best_params, param_list, elapsed_formatted)
