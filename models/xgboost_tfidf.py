...
# -----------------------------
X_train_val = joblib.load(os.path.join(PROJECT_ROOT, 'data', 'tfidf/X_train_tfidf.pkl'))

X_test = joblib.load(os.path.join(PROJECT_ROOT, 'data', 'tfidf/X_test_tfidf.pkl'))

y_train_val = joblib.load(os.path.join(PROJECT_ROOT, 'data', "tfidf/y_train_tfidf.pkl")).values.ravel()
...
export_model('xgboost_tfidf', best_estimator)
export_classification_reports('xgboost_tfidf', y_pred, y_test, best_params, param_list, elapsed_formatted)